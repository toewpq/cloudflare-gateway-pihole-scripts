  ...
  try {
    await requestGateway("/rules", {
      ...
      body: JSON.stringify({
        name,
        description:
          "由 Cloudflare Gateway Pi-hole 脚本创建的过滤器列表。避免编辑此规则。更改此规则的名称将破坏脚本。",
        enabled: true,
        action: "block",
        rule_settings: { "block_page_enabled": BLOCK_PAGE_ENABLED, "block_reason": "被 CGPS 阻止，请检查您的过滤器列表是否有误。" },
        filters,
